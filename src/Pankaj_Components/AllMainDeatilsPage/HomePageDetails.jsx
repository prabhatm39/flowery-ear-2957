    ...
    <div className="main_DetailsPage">
      <div className="details_left">
          <div className="flexClass">
              <img src="https://cdn1.tripoto.com/assets/2.9/img/logo/mini-logo.png" width="20" height="20" style={{marginTop:'0.7rem', marginRight:'0.5rem'}}/>
          ...
          <div className="mainContent">
            ...
            <div className="ArticleClass">
              ...
              <img src="https://static2.tripoto.com/media/filter/nl/img/533625/Image/1659596283_cover.jpeg" width="90%" alt="" />
            ...
            <div className="Article_Sec">
              <h2 style={{textAlign:'left',marginLeft:'3rem'}}>MUNNAR</h2>
              <img src="https://cdn1.tripoto.com/media/filter/nl/img/533625/Image/1659596310_munnar.jpeg" width="90%" height="400px" alt="munar" />
              <p className="articleText">
            ...
            <div className="Article_Sec">
              <h2 style={{textAlign:'left',marginLeft:'3rem'}}>MUNNAR</h2>
              <img src="https://cdn1.tripoto.com/media/filter/nl/img/533625/Image/1659596092_munnar.jpeg" width="90%" height="400px" alt="" />
              <p className="articleText">
              ...
              <p className="articleText">
                <b>More information</b> here
              </p>
            </div>
            <div className="Article_Sec">
              <h2 style={{textAlign:'left',marginLeft:'3rem'}}>GOA</h2>
              <img src="https://cdn1.tripoto.com/media/filter/nl/img/533625/Image/1659596436_goa.jpeg" width="90%" height="400px" alt="munar" />
              <p className="articleText">
            ...
            <div className="Article_Sec">
              <img src="https://cdn1.tripoto.com/media/filter/nl/img/533625/Image/1659596664_screenshot_2022_08_04_at_12_34_13_pm.png" width="90%" height="400px" alt="munar" />
              <p className="articleText">
            ...
            <div className="Article_Sec">
              <img src="https://cdn1.tripoto.com/media/filter/nl/img/533625/Image/1659596172_screenshot_2022_08_04_at_12_26_00_pm.png" width="90%" height="400px" alt="munar" />
              <p className="articleText">
