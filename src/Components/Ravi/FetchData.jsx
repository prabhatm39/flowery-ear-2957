...
import { getDomesticData, getInternationalData, getMindData } from "../Redux/AppRedux/action";
...
const FetchData = () => {
    ...
    let mind = useSelector((state) => state.AppRedux.mind);
    let domestic = useSelector((state) => state.AppRedux.domestic);
    let international = useSelector((state) => state.AppRedux.international);
